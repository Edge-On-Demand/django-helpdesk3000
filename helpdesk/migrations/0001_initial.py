    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allow_group_users', models.BooleanField(default=False, help_text='If checked, and the group is set, all users belonging\n            to the group will effectively have staff permissions for viewing\n            and editing this queue.')),
                ('group', models.ForeignKey(related_name='helpdesk_queues', blank=True, to='auth.Group', help_text='If specified, non-staff users added to this group will\n            be able to view and edit this queue.', null=True)),
            ],
            options={
                'ordering': ('title',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.IntegerField(default=3, help_text='1 = Highest Priority, 5 = Low Priority', blank=3, verbose_name='Priority', choices=[(1, 'Critical'), (2, 'High'), (3, 'Normal'), (4, 'Low'), (5, 'Very Low')])),
